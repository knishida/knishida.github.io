...
1. Kazutoshi Shinoda, Kosuke Nishida, Kyosuke Nishida, "Debiasing Reward Models via Causally Motivated Inference-Time Intervention", in Proceedings of the 64th Annual Meeting of the Association for Computational Linguistics (ACL 2026), pp. 22474–22489, July 2026.
...
1. Kosuke Nishida, Kyosuke Nishida, Itsumi Saito, "InstructSum: A Benchmark to Evaluate Instruction-Following Capability of Large Language Models in Summarization", in Proceedings os the Fifteenth Language Resources and Evaluation Conference (LREC 2026), pp. 9940-9952, May 2026.

1. Daiki Chijiwa, Taku Hasegawa, Kyosuke Nishida, Shin'ya Yamaguchi, Tomoya Ohba, Tamao Sakao, Susumu Takeuchi: "Lossless Vocabulary Reduction for Auto-Regressive Language Models", in Proceedings of the Fourteenth International Conference on Learning Representations (ICLR 2026), April 2026.
...
1. Yui Oka, Kentaro Hanafusa, Taku Hasegawa, Kyosuke Nishida, Kuniko Saito: "Probing Rotary Position Embeddings through Frequency Entropy", in Proceedings of the Fourteenth International Conference on Learning Representations (ICLR 2026), April 2026.
