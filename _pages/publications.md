...
1. Kosuke Nishida, Kyosuke Nishida, Itsumi Saito, "[InstructSum: A Benchmark to Evaluate Instruction-Following Capability of Large Language Models in Summarization](https://aclanthology.org/2026.lrec-1.779/)", in Proceedings os the Fifteenth Language Resources and Evaluation Conference (LREC 2026), pp. 9940-9952, May 2026.

1. Daiki Chijiwa, Taku Hasegawa, Kyosuke Nishida, Shin'ya Yamaguchi, Tomoya Ohba, Tamao Sakao, Susumu Takeuchi: "[Lossless Vocabulary Reduction for Auto-Regressive Language Models](https://openreview.net/forum?id=xAvqHtLVgz)", in Proceedings of the Fourteenth International Conference on Learning Representations (ICLR 2026), April 2026.

1. Yui Oka, Itsumi Saito, Kyosuke Nishida, Kuniko Saito: "[Frequency Bands in RoPE: Base Frequency and Context Length Shape the Interpolation–Extrapolation Trade-off]()", in Proceedings of the Fourteenth International Conference on Learning Representations (ICLR 2026),  April 2026.

1. Yui Oka, Kentaro Hanafusa, Taku Hasegawa, Kyosuke Nishida, Kuniko Saito: "[Probing Rotary Position Embeddings through Frequency Entropy](https://openreview.net/forum?id=1JZuEDq62N)", in Proceedings of the Fourteenth International Conference on Learning Representations (ICLR 2026), April 2026.

1. Kazutoshi Shinoda, Nobukatsu Hojo, Kyosuke Nishida, Yoshihiro Yamazaki, Keita Suzuki, Hiroaki Sugiyama, Kuniko Saito, "[Let's Put Ourselves in Sally's Shoes: Shoes-of-Others Prefilling Improves Theory of Mind in Large Language Models](http://aclanthology.org/2026.findings-eacl.6/)", in Findings of the 19th Conference of the European Chapter of the Association for Computational Linguistics (EACL 2026 findings): pp. 95-109, March 2026.

1. Sora Kadotani, Kosuke Nishida, Kyosuke Nishida: "[Learning from Hallucinations: Mitigating Hallucinations in LLMs via Internal Representation Intervention](https://aclanthology.org/2025.findings-ijcnlp.68)", in Findings of the 14th International Joint Conference on Natural Language Processing and the 4th  Conference of the the Asia-Pacific Chapter of the Association for Computational Linguistics (IJCNLP-AACL findings 2025), pp. 1136–1143, December 2025.
...
](https://proceedings.mlr.press/v267/chijiwa25a.html)", in Proceedings of Forty-second International Conference on Machine Learning (ICML 2025), July 2025.

1. Nobukatsu Hojo, Kazutoshi Shinoda, Yoshihiro Yamazaki, Keita Suzuki, Hiroaki Sugiyama, Kyosuke Nishida, Kuniko Saito: [GenerativeGUI: Dynamic GUI Generation Leveraging LLMs for Enhanced User Interaction on Chat Interfaces](https://doi.org/10.1145/3706599.3719743), in Proceedings of the Extended Abstracts of the CHI Conference on Human Factors in Computing Systems (CHI Extended Abstracts), pp. 306:1-306:9, May 2025.

1. Yui Oka, Taku Hasegawa, Kyosuke Nishida, Kuniko Saito: "[Wavelet-based Positional Representation for Long Context](https://openreview.net/forum?id=OhauMUNW8T)", in Proceedings of the Thirteenth International Conference on Learning Representations (ICLR 2025), April 2025.

1. Kazutoshi Shinoda, Nobukatsu Hojo, Kyosuke Nishida, Saki Mizuno, Keita Suzuki, Ryo Masumura, Hiroaki Sugiyama, Kuniko Saito: "[ToMATO: Verbalizing the Mental States of Role-Playing LLMs for Benchmarking Theory of Mind](https://doi.org/10.1609/aaai.v39i2.32143)", in Proceedings of Thirty-Ninth AAAI Conference on Artificial Intelligence (AAAI 2025), pp. 1520-1528, February 2025.

1. Kosuke Nishida, Kyosuke Nishida, Kuniko Saito: "[Initialization of Large Language Models via Reparameterization to Mitigate Loss Spikes](https://doi.org/10.18653/v1/2024.emnlp-main.1264)", in Proceedings of the 2024 Conference on Empirical Methods in Natural Language Processing (EMNLP 2024), pp. 22699-22714, November 2024.

1. Ryota Tanaka, Taichi Iki, Kyosuke Nishida, Kuniko Saito, Jun Suzuki, "[InstructDoc: A Dataset for Zero-Shot Generalization of Visual Document Understanding with Instructions](https://doi.org/10.1609/aaai.v38i17.29874)" in Proceedings of the 37th AAAI Conference on Artificial Intelligence (AAAI 2024), February 2023. [github](https://github.com/nttmdlab-nlp/InstructDoc)
...
1. Ryota Tanaka, Taku Hasegawa, Kyosuke Nishida, "[CMDR: Contextual Multimodal Document Retrieval](https://arxiv.org/abs/2607.05927)", arXiv, 2607.05927, July 2027.

1. Kazutoshi Shinoda, Kosuke Nishida, Kyosuke Nishida, "[Debiasing Reward Models via Causally Motivated Inference-Time Intervention](https://arxiv.org/abs/2604.27495)", arXiv, 2604.27495, April 2026.

1. Haruka Kawasaki, Ryota Tanaka, Kyosuke Nishida, "[Responses Fall Short of Understanding: Revealing the Gap between Internal Representations and Responses in Visual Document Understanding](https://arxiv.org/abs/2604.04411)", arXiv, 2604.04411, April 2026.
