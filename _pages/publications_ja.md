...
1. 山﨑善啓, 北条伸克, 鈴木啓太, 小篭蒼, 三浦大和, 西田京介, Webエージェントのタスク遂行を阻害するWebサイト特性の帰納的分析, NLP若手の会 (YANS) 第20回シンポジウム (2026), S3-P46, August 2026.

1. 勝見久央, 吉野幸一郎, 水上雅博, 西田京介, タスク指向対話におけるLLMエージェントの「気遣い」の能力を測るベンチマークの構築, NLP若手の会 (YANS) 第20回シンポジウム (2026), S3-P43, August 2026.

1. 中石海, 岡佑依, 山本悠士, 西田京介, 横井祥, 言語モデルの長文処理能力の統計物理学的特徴づけ, 2026年度人工知能学会全国大会（JSAI2026), 2Yin-B-13, July 2026. 

1. 杉山誠治, 近藤里咲, 梶原智之, 水上雅博, 西田京介, タスク指向対話におけるペルソナの影響の検証, 2026年度人工知能学会全国大会（JSAI2026), 4Yin-B-62, July 2026. 

1. 高橋舞衣, 風戸広史, 西田京介, JEvalPlusによる日本語と英語のタスク指示を用いたコードLLMの性能分析, 2026年度人工知能学会全国大会（JSAI2026), 5Yin-A-11, July 2026. 

1. 田中涼太, 長谷川拓, 西田京介, CMDR: 文脈を考慮したマルチモーダル文書検索, 言語処理学会第32回年次大会（NLP2026）, C4-12, March 2026. **優秀賞（16/789件）**

1. 岡佑依, 花房健太郎, 長谷川拓, 西田京介,	周波数エントロピーによる位置埋込みの解明, 言語処理学会第32回年次大会（NLP2026）, B6-20, March 2026. **優秀賞（16/789件）**

1. 岡佑依, 斉藤いつみ, 西田京介, 位置符号化の基底拡大戦略は外挿性能を制限する, 言語処理学会第32回年次大会（NLP2026）, C7-20, March 2026. **優秀賞（16/789件）**

1. 篠田一聡, 北条伸克, 西田京介, 山﨑善啓, 鈴木啓太, 杉山弘晃, 齋藤邦子, Let's Put Ourselves in Sally's Shoes: 他人の靴プレフィリングは大規模言語モデルの心の理論を改善する, 言語処理学会第32回年次大会（NLP2026）, Q7-3, March 2026. **優秀賞（16/789件）**

1. 門谷宙, 西田光甫, 西田京介, ハルシネーションから学ぶ：内部表現への介入によるハルシネーション抑制, 言語処理学会第32回年次大会（NLP2026）, B2-17, March 2026. **若手奨励賞（21/517件）**

1. 西田光甫, 西田京介, 多目的直接選好最適化における次元衝突のカリキュラム学習による抑制, 言語処理学会第32回年次大会（NLP2026）, C8-8, March 2026.

1. 川﨑春佳, 田中涼太, 壹岐太一, 西田京介, 視覚的文書理解モデルの内部機序に基づくチューニング, 言語処理学会第32回年次大会（NLP2026）, C3-13, March 2026.

1. 壹岐太一, 西田京介, 齋藤邦子, 動的解像度ViT付きVLMのFeature Alignmentにおける画像構成要素の学習, 言語処理学会第32回年次大会（NLP2026）, C4-21, March 2026.

1. 辻航平, 岡佑依, 西田京介, 坂井優介, 上垣外英剛, 渡辺太郎, 	疑似グラフデータ学習によるLLMのグラフ理解能力の向上, 言語処理学会第32回年次大会（NLP2026）, B7-5, March 2026.
  
1. 吉田琉夏, 西田光甫, 西田京介, 大規模言語モデルの推論過程誤り分析に基づく推論能力の向上, 言語処理学会第32回年次大会（NLP2026）, B8-6, March 2026.

1. 高橋未央, 蔵内雄貴, 神山歩相名, 西田 京介,日本語LLM の事前学習データの品質・構成が性能に与える影響, 言語処理学会第32回年次大会（NLP2026）, C8-18, March 2026.

1. 勝見久央, 水上雅博, 神山歩相名, 西田 京介, Chain-of-Argumentation: LLMエージェントによる論証構築のための情報探索戦略, NLP若手の会 (YANS) 第19回シンポジウム (2025), S1-P22, June 2025.

1. 川﨑春佳, 壹岐太一, 田中涼太, 西田 京介, 文書画像理解における大規模視覚言語モデルの内部表現は回答に反映されているのか？, NLP若手の会 (YANS) 第19回シンポジウム (2025), S2-P21, June 2025.

1. 大賀悠平, 大塚淳史, 有本庸浩, 水上雅博, 勝見久央, 西田京介, 大庭隆伸, 甘粕哲郎, RAGシステムにおけるビジネス文書処理能力の評価用データセットの構築, NLP若手の会 (YANS) 第19回シンポジウム (2025), S5-P19, June 2025.

1. 岡佑依, 長谷川拓, 西田京介, 齋藤 邦子, ウェーブレット位置符号化, 言語処理学会第31回年次大会（NLP2025）, P2-4, March 2025. **優秀賞（14/765件）**

1. 西田光甫, 西田京介, 齋藤邦子, 大規模言語モデルの再パラメタ化に基づく初期化による損失スパイクの抑制, 言語処理学会第31回年次大会（NLP2025）, C10-5, March 2025. **優秀賞（14/765件）**

1. 田中涼太, 壹岐太一, 長谷川拓, 西田京介, 齋藤邦子, 鈴木潤, VDocRAG: 視覚的文書に対する検索拡張生成, 言語処理学会第31回年次大会（NLP2025）, C9-4, March 2025., **委員特別賞（32/726件）**

1. 篠田一聡, 北条伸克, 西田京介, 水野沙希, 鈴木啓太, 増村亮, 杉山弘晃, 斎藤邦子, ToMATO: 心の理論ベンチマークのためのロールプレイングLLMの心的状態の言語化, 言語処理学会第31回年次大会（NLP2025）, B3-6, March 2025.

1. 有山知希, 鈴木潤, 鈴木正敏, 田中涼太, 赤間怜奈, 西田京介, クイズコンペティションの結果分析から見た日本語質問応答の到達点と課題, 言語処理学会第31回年次大会（NLP2025）,  Q7-23J, March 2025. **2024年言語処理学会論文賞 (1/22件)**

1. 門谷宙, 西田光甫, 西田京介, 齋藤邦子, In-model anti-expertによる大規模言語モデルのハルシネーション抑制, NLP若手の会 (YANS) 第18回シンポジウム (2024), S2-P20, September 2024.
   
1. 田中涼太, 壱岐太一, 西田京介, 齋藤邦子, 鈴木潤, InstructDoc: 自然言語指示に基づく視覚的文書理解, 言語処理学会第30回年次大会（NLP2024）, C3-4, March 2024. **優秀賞（12/599件）**

1. 西田光甫, 吉永直樹, 西田京介, クロスドメイン検索型質問応答のためのニューラル疎ベクトル検索, 言語処理学会第30回年次大会（NLP2024）, C1-3, March 2024.
   
1. 門谷宙, 西田光甫, 西田京介, 齋藤邦子, 大規模言語モデルは自身の Hallucination を検知できるか?, 言語処理学会第30回年次大会（NLP2024）, A2-1, March 2024.
   
1. 大賀悠平, 長谷川拓, 西田京介, 齋藤邦子, LLMを用いた不適切発話データの自動生成に関する研究, 言語処理学会第30回年次大会（NLP2024）, C8-3, March 2024.
...
1. 田中涼太, 西田京介, 西田光甫, 長谷川拓, 斉藤いつみ, 齋藤邦子, "SlideVQA: 複数の文書画像に対する質問応答", 言語処理学会第29回年次大会（NLP2023）, A11-4, March 2023. **優秀賞 (11/579件)**, **言語資源賞 (2/97件)**

1. 西田光甫, 西田京介, 斉藤いつみ, 齋藤邦子, "InstructSum: 自然言語の指示による要約の生成制御", 言語処理学会第29回年次大会（NLP2023）, H5-4, March 2023. **委員特別賞 (26/579件)**

1. 西田京介(\*), 長谷川拓(\*), 前田航希, 齋藤邦子, "DueT: 視覚・言語のDual-adapter Tuningによる基盤モデル", 言語処理学会第29回年次大会（NLP2023）, B7-3, March 2023. **委員特別賞 (26/579件)** (\*: equal contribution.)

1. 西田光甫, 西田京介, 西岡秀一, "機械・人の双方が言語で概念を説明可能なFew-shot 画像分類",  言語処理学会第28回年次大会（NLP2022）, E5-4，March 2022. **優秀賞 (7/386件)**
...
1. Diana Galvan-Sosa, 西田京介, 松田耕史, 鈴木潤, 乾健太郎, "テキストを通して世界を見る:機械読解における常識的推論のための画像説明文の評価", 言語処理学会第26回年次大会（NLP2020）, D3-2, March 2020. **優秀賞 (6/396件)**
...
1. 西田京介, 斉藤いつみ, 西田光甫, 篠田一聡, 大塚淳史, 浅野久子, 富田準二, "回答スタイルを制御可能な生成型機械読解", 言語処理学会第25回年次大会（NLP2019）, B1-1, March 2019. **優秀賞 (5/398件)**
...
1. 岡佑依, 柳本大輝, 平尾努, 西田京介, 談話関係ラベル付き接続語認識, 自然言語処理, 2025年 32 巻 2 号 633-659, June 2025.

1. 有山知希, 鈴木潤, 鈴木正敏, 田中涼太, 赤間伶奈, 西田京介,  "クイズコンペティションの結果分析から見た日本語質問応答の到達点と課題", 自然言語処理,  2024 年 31 巻 1 号, March 2024. **2024年言語処理学会論文賞 (1/22件)**
...
1. 西田京介, [特定分野の専門知識を持った高性能で低消費エネルギーのLLM、tsuzumi](https://doi.org/10.60249/24061101)",  NTT技術ジャーナル  Vol. 22 No. 8, 2024年8月.

1. 清水健太郎, 西田光甫, 西田京介, "[NTT版LLM「tsuzumi」](https://doi.org/10.60249/24065001)", NTT技術ジャーナル  Vol. 22 No. 8, 2024年8月.

1. 田中涼太, 壹岐太一, 長谷川拓, 西田京介, "[グラフィカルな文書を理解できる「tsuzumi」](https://doi.org/10.60249/24065002)", NTT技術ジャーナル  Vol. 22 No. 8, 2024年8月.
