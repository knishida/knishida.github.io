...
1. 田中涼太, 長谷川拓, 西田京介, CMDR: 文脈を考慮したマルチモーダル文書検索, 言語処理学会第32回年次大会（NLP2026）, C4-12, March 2026.

1. 岡佑依, 花房健太郎, 長谷川拓, 西田京介,	周波数エントロピーによる位置埋込みの解明, 言語処理学会第32回年次大会（NLP2026）, B6-20, March 2026.

1. 岡佑依, 斉藤いつみ, 西田京介, 位置符号化の基底拡大戦略は外挿性能を制限する, 言語処理学会第32回年次大会（NLP2026）, C7-20, March 2026.	

1. 篠田一聡, 北条伸克, 西田京介, 山﨑善啓, 鈴木啓太, 杉山弘晃, 齋藤邦子, Let's Put Ourselves in Sally's Shoes: 他人の靴プレフィリングは大規模言語モデルの心の理論を改善する, 言語処理学会第32回年次大会（NLP2026）, Q7-3, March 2026.

1. 門谷宙, 西田光甫, 西田京介, ハルシネーションから学ぶ：内部表現への介入によるハルシネーション抑制, 言語処理学会第32回年次大会（NLP2026）, B2-17, March 2026.
